...
from account_app.models import User,PendingUser
...
class UserCreationForm(forms.ModelForm):
    ...
    password1 = forms.CharField(label=" گذروازه ", widget=forms.PasswordInput)
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ["email", "password", "is_active", "is_admin","full_name"]
